...
//       <Button
//         icon
//         className='md-cell--right bottom-navigations__dynamic__kebab'
//       >
//         more_vert
//       </Button>
//     );
...
//     <section
//       className={cn(
//         'md-cell md-cell--12 bottom-navigations__dynamic__section',
//         className
//       )}
//       {...props}
//     >
...
//         <h3>{title}</h3>
//         <Button flat className='md-cell--right' primary>
//           More
//         </Button>
//       </header>
//       <ul className={cn('md-list-unstyled md-grid', listClassName)}>{cards}</ul>
//     </section>
//   );
// };
